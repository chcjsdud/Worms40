...
void PixelCollision::CheckPixel(CheckType _MyType, float4 _MyPos, float4 _MyScale, GameEngineImage* _ColMapImage, float4 _BulletDir)
{
	...
	case CheckType::WeaponGrenade:
		Bounce(_MyPos,_MyScale, _ColMapImage, _BulletDir);
		break;
	default:
		break;
	}
